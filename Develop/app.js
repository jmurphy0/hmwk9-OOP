...
function main() {
  // get input from user via inquirer
  inquirer
    .prompt([
      {
        type: "input",
...
async function addMember() {
  // Inquirer prompt to add new memebers
  try {
    let addMem = inquirer
      .prompt([
        {
              ...
              if (data.role === "ENGINEER") {
                inquirer
                  .prompt([
                    ...
                    {
                      type: "input",
                      message: "Enter id number of the engineer: ",
                      name: "id",
                    },
                    {
                      type: "input",
                    ...
                    {
                      type: "input",
                      message: "Enter gitHub accout of engineer: ",
                      name: "github",
                    },
                  ])
                  .then(function (data) {
